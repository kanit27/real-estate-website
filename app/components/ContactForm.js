...
export default function ContactForm() {
  ...
  return (
    <motion.form
      ...
      className="relative w-full mb-4 pt-10 md:pt-20 flex flex-col md:flex-row justify-center items-center md:gap-0 gap-10"
    >
      <img
...
/>
      <div className="items-start gap-3 md:gap-3 md:ml-80 flex flex-col w-full md:w-auto px-4 md:px-0">
        ...
        <a href="mailto:alivirani09@gmail.com" className="hover:underline">
          alivirani09@gmail.com
        </a>
        <a href="tel:+919723600650" className="hover:underline">
          +91 97236 00650
        </a>
      </div>
